...
class ProductCollectionProvider extends PsProvider {
  ...
  Future<dynamic> loadProductCollectionListByShopId(String shopId) async {
    isLoading = true;
    isConnectedToInternet = await Utils.checkInternetConnectivity();
    await _repo.getProductCollectionListByShopId(productCollectionListStream,
        isConnectedToInternet,shopId, limit, offset, PsStatus.PROGRESS_LOADING);
  }
  ...
  Future<dynamic> nextProductCollectionListByShopId(String shopId) async {
    ...
    if (!isLoading && !isReachMaxData) {
      ...
      await _repo.getNextPageProductCollectionListByShopId(productCollectionListStream,
          isConnectedToInternet,shopId, limit, offset, PsStatus.PROGRESS_LOADING);
    }
  }
