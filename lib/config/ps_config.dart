...
class PsConfig {
  ...
  static const String ps_app_url =
      'https://admin.saviansdish.com/index.php/';

  static const String ps_app_image_url =
      'https://admin.saviansdish.com/uploads/';

  static const String ps_app_image_thumbs_url =
      'https://admin.saviansdish.com/uploads/thumbnail/';
  ...
  ///
  static const String tmpImageFolderName = 'Ayah';
  ...
  static String defaultRazorCurrency = 'USD';
}
