...
import 'package:flutterrestaurant/provider/product/discount_product_provider.dart';
import 'package:flutterrestaurant/provider/product/search_product_provider.dart';
import 'package:flutterrestaurant/provider/product/trending_product_provider.dart';
import 'package:flutterrestaurant/provider/shop/new_shop_provider.dart';
import 'package:flutterrestaurant/provider/shop/trending_shop_provider.dart';
...
import 'package:flutterrestaurant/repository/shop_repository.dart';
import 'package:flutterrestaurant/ui/category/item/category_horizontal_list_item.dart';
...
import 'package:flutterrestaurant/ui/map/home_location_view.dart';
import 'package:flutterrestaurant/ui/product/item/product_horizontal_list_item.dart';
import 'package:flutterrestaurant/ui/shop_list/item/shop_horizontal_list_item.dart';
...
import 'package:flutterrestaurant/viewobject/holder/intent_holder/shop_data_intent_holder.dart';
import 'package:flutterrestaurant/viewobject/holder/intent_holder/shop_list_intent_holder.dart';
...
class _MainDashboardViewWidgetState extends State<MainDashboardViewWidget> {
  ...
  void getStoredAddress() async{
    final prefs = await PsSharedPreferences.instance.shared;

   setState(() {
     storedAddress = prefs.getString('storedAddress');
   });
