...
import 'package:flutterrestaurant/ui/dashboard/home/main_dashboard_view.dart';
...
import 'package:flutterrestaurant/ui/reservation/entry/create_reservation_view.dart';
import 'package:flutterrestaurant/ui/reservation/list/reservation_list_view.dart';
import 'package:flutterrestaurant/ui/search/home_item_search_view.dart';
import 'package:flutterrestaurant/ui/terms_and_conditions/terms_and_conditions_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // backgroundColor:Color(0xFF365742),
          title: Text(
            appBarTitle,
          ...
          leading: GestureDetector(
            child: Icon(Icons.sort_sharp,color: Colors.white,),
            onTap: (){
          ...
          actions: <Widget>[
            ...
            //                       ? '99+'
            //                       : basketProvider.basketList.data.lengths
            //                           .toString(),
            ...
            ? Visibility(
                ...
                child: Container(
                  child: BottomNavigationBar(
                    ...
                    backgroundColor: Color(0xFFf4042e),
        ...
        children: <Widget>[
          Row(
            ...
            children: [
              ...
              // ),
              Image.asset('assets/images/transparent.png',height: 70,width: 70,fit: BoxFit.cover,),
              SizedBox(width: 10,),
