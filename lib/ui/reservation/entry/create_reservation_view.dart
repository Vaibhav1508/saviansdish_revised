...
import 'package:flutterrestaurant/provider/shop/shop_provider.dart';
...
class _CreateReservationViewState extends State<CreateReservationView> {
  ...
  final TextEditingController reservationTimeController =
      TextEditingController();
  final TextEditingController reservationShopController =
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    shopRepo = Provider.of<ShopRepository>(context);
      ...
      providers: <SingleChildWidget>[
        ChangeNotifierProvider<CreateReservationProvider>(
          ...
          create: (BuildContext context) {
            ...
            reservationProvider.selectedShopId = widget.shopId;
            reservationProvider.selectedShopName = widget.shopName;
        ...
        ChangeNotifierProvider<ShopProvider>(
          ...
          create: (BuildContext context) {
            final ShopProvider shopProvider =
                ShopProvider(repo: shopRepo, psValueHolder: psValueHolder);
            shopProvider.loadShopListByKey(shopParameterHolder);
            return shopProvider;
          },
        ),
      ...
      child: Consumer<UserProvider>(builder:
        ...
        if (userProvider != null &&
          ...
          if (bindDataFirstTime) {
            ...
            reservationShopController.text =
                reservationProvider.selectedShopName;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    PsDropdownBaseWithControllerWidget(
                        title: Utils.getString(
                            context, 'create_reservation__reservation_shop'),
                        textEditingController: reservationShopController,
                        isMandatory: true,
                        onTap: () async {
                          final dynamic result = await Navigator.pushNamed(
                            context,
                            RoutePaths.reservationshopList,
                          );
                          if (result != null && result is Shop) {
                            reservationProvider.selectedShopId = result.id;
                            reservationProvider.selectedShopName = result.name;

                            reservationShopController.text = result.name;
                          }
                        }),
                    ...
                    Container(
                      ...
                      child: PsButtonWidget(
                          ...
                          reservationShopController: reservationShopController),
                    ),
                    _largeSpacingWidget,
                  ],
                ),
...
class PsButtonWidget extends StatelessWidget {
  const PsButtonWidget(
      ...
      @required this.reservationShopController,
